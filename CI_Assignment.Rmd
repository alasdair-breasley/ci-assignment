...
year = c(2015.25, 2016.25, 2017.25, 2018.25, 2019.25, 2020.25)

dif_in_dif_2y_estimates_placebo = data.frame(year, dif_in_dif_2y_estimates)

# Placebo test results for every two year time period prior to and spanning the intervention date 
ggplot(data = dif_in_dif_2y_estimates_placebo, aes(x = year, y = dif_in_dif_1y_estimates)) +
  geom_line(size = 1, linetype = "dotted", color = "black", size = 0.75, alpha = 0.75) +
  geom_point(shape = 45, size = 15, color = "black") +
  ...
  annotate("text", x = 2018.895, y = -47.5, label = "Intervention Date", color = "red", size = 4) +
  scale_x_continuous(breaks = breaks_width(1), minor_breaks = NULL) +
  scale_y_continuous(breaks = breaks_width(10), limits = c(-50, 50)) +
...
dif_in_dif_1y_estimates_placebo = data.frame(year, dif_in_dif_1y_estimates)
