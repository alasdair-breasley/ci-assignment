...
dif_in_dif_basic = matched_local_authorities %>% 
...
pre_treat = mean(dif_in_dif_basic$`2017_treat`)
post_treat = mean(dif_in_dif_basic$`2019_treat`)
pre_control = mean(dif_in_dif_basic$`2017_control`)
post_control = mean(dif_in_dif_basic$`2019_control`)

dif_in_dif_basic_estimate = (post_treat - pre_treat) - (post_control - pre_control)
...
hospitalisations_long = dif_in_dif_basic %>% 
