...
matched_details = merge(matched_details, local_authority_characteristics_has_per100k, by.x = "Control_ID", by.y = "row.names", suffixes = c(".treat", ".control"))

# Just local authorities 
matched_local_authorities = matched_details %>% 
  dplyr::select(Control_ID, Row.names, local_authority.treat, local_authority.control)
