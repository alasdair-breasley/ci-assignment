...
s_plot = stripplot(mice_model, employment_rate_16to64, pch = 20, cex = 1.2, alpha = 1)
...
ggplot(data = hospitalisations_long, aes(x = year, y = stays_per100k, colour = group)) +
  ...
  geom_vline(aes(xintercept = 2017.92, color = "Intervention Announcement"), size = 0.6, alpha = 0.8) +
