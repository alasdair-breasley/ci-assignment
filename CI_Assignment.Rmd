...
if (mice_imputation == TRUE) {
  ...
  methods = rep("norm.predict", ncol(local_authority_characteristics))
  names(methods) = colnames(local_authority_characteristics)
  methods["local_authority"] = ""
  
  # local_authority_characteristics = mice(local_authority_characteristics, m = 5, method = methods, predictorMatrix = pred_matrix, seed = 123, printFlag = TRUE)
  
  mice_model = mice(local_authority_characteristics, method = methods, predictorMatrix = pred_matrix, seed = 123, printFlag = TRUE)
  
  local_authority_characteristics = complete(mice_model)
