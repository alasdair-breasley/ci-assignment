...
s_plot = update(s_plot, 
                main = "Imputed Values (Red) for Economic Activity Rate for 16- to 64-Year-Old Residents", 
                xlab = "Imputation Run (0 = Initial Dataset)", 
                ylab = "Employment Rate")
...
s_plot = update(s_plot, 
                main = "Imputed Values (Red) for Unemployment Rate for 16- to 64-Year-Old Residents", 
                xlab = "Imputation Run (0 = Initial Dataset)", 
                ylab = "Employment Rate")
